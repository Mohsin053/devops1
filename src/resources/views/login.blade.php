...
<body>
    ...
    <div class = "less">
        ...
        <div class="container">
            <p>Have An Account?</p>
            <form method="post" id ="form" action='/login' onsubmit = "return checkblank()" enctype="multipart/form-data">
            @csrf
            ...
            ?>
            <button type="submit" class="btn btn-primary" onclick= "checkblank()">LogIn</button>
